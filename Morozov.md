...
В концептуальной модели будут использованы сущности: **Клиенты**, **Квартиры**, **Аренда** и **Сотрудники**, с определенными атрибутами и отношениями. Модель будет отображать взаимодействие клиентов с квартирами через аренду, а также назначение сотрудников для управления процессом аренды.
